...
**From SDK version 1.0.6:** You may choose not to provide `appID` when creating `KinClient` instance. In that case, The SDK won't append the `AppID` prefix to the transaction memo. As a rule of thumb, you almost always want to provide your `appID`.
